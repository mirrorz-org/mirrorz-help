...
TODO: fix tuna mirrors.url force redirect help
...
```bash
curl -OC - TODO/aosp-monthly/aosp-latest.tar # 下载初始化包
...
**如果提示无法连接到 gerrit.googlesource.com，请参照[git-repo的帮助页面](https://help.mirrorz.org/git-repo/)的更新一节。**
