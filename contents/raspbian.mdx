...
deb [arch=arm64] {{http_protocol}}{{mirror}}/multiarch/ {{release_name}} main
```
...
aarch64 用户可直接参考 [Debian 帮助](https://help.mirrorz.org/debian/)

#### raspberry 镜像

对于两个架构，编辑 `/etc/apt/sources.list.d/raspi.list` 文件，这需要查看 [Raspberrypi 帮助](https://help.mirrorz.org/raspberrypi/)。
