  ...
  menus={[
    {
      title: 'Debian 版本',
      items: [
        ['Debian 12 (bookworm)', { release_name: 'bookworm', is_sid: '' }],
        ['sid', { release_name: 'sid', is_sid: '# ' }],
        ['testing', { release_name: 'testing',  is_sid: '' }],
      ]
    },
    {
      title: '启用源码镜像',
...
{{enable_source}}Suites: {{release_name}}
...
{{is_sid}}Suites: {{release_name}}-updates {{release_name}}-backports
{{is_sid}}Components: main contrib non-free non-free-firmware
{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg

{{enable_source}}{{is_sid}}Types: deb-src
{{enable_source}}{{is_sid}}URIs: {{http_protocol}}{{mirror}}
{{enable_source}}{{is_sid}}Suites: {{release_name}}-updates {{release_name}}-backports
{{enable_source}}{{is_sid}}Components: main contrib non-free non-free-firmware
{{enable_source}}{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg

{{security_mirror}}{{is_sid}}Types: deb
{{security_mirror}}{{is_sid}}URIs: {{http_protocol}}{{mirror}}-security
{{security_mirror}}{{is_sid}}Suites: {{release_name}}-security
{{security_mirror}}{{is_sid}}Components: main contrib non-free non-free-firmware
{{security_mirror}}{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg

{{security_mirror}}{{enable_source}}{{is_sid}}Types: deb-src
{{security_mirror}}{{enable_source}}{{is_sid}}URIs: {{http_protocol}}{{mirror}}-security
{{security_mirror}}{{enable_source}}{{is_sid}}Suites: {{release_name}}-security
{{security_mirror}}{{enable_source}}{{is_sid}}Components: main contrib non-free non-free-firmware
{{security_mirror}}{{enable_source}}{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg

{{security_official}}{{is_sid}}Types: deb
{{security_official}}{{is_sid}}URIs: http://security.debian.org/debian-security
{{security_official}}{{is_sid}}Suites: {{release_name}}-security
{{security_official}}{{is_sid}}Components: main contrib non-free non-free-firmware
{{security_official}}{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg

{{security_official}}{{enable_source}}{{is_sid}}Types: deb-src
{{security_official}}{{enable_source}}{{is_sid}}URIs: http://security.debian.org/debian-security
{{security_official}}{{enable_source}}{{is_sid}}Suites: {{release_name}}-security
{{security_official}}{{enable_source}}{{is_sid}}Components: main contrib non-free non-free-firmware
{{security_official}}{{enable_source}}{{is_sid}}Signed-By: /usr/share/keyrings/debian-archive-keyring.gpg
```
