  ...
  menus={[
    {
      ...
      items: [
        ...
        ['Debian 10 (buster)', { release_name: 'buster', has_backports: '' }],
        ['Debian 9 (stretch)', { release_name: 'stretch', has_backports: '' }],
        ['Debian 8 (jessie)', { release_name: 'jessie', has_backports: '' }]
      ]
    },
    {
      title: '启用源码镜像',
