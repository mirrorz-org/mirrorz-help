...
{{enable_source}}{{is_sid}}Components: main contrib non-free{{has_nfw}}

{{security_mirror}}{{is_sid}}Types: deb
{{security_mirror}}{{is_sid}}URIs: {{http_protocol}}{{mirror}}
{{security_mirror}}{{is_sid}}Suites: {{release_name}}-security
{{security_mirror}}{{is_sid}}Components: main contrib non-free{{has_nfw}}

{{security_mirror}}{{enable_source}}{{is_sid}}Types: deb-src
{{security_mirror}}{{enable_source}}{{is_sid}}URIs: {{http_protocol}}{{mirror}}
{{security_mirror}}{{enable_source}}{{is_sid}}Suites: {{release_name}}-security
{{security_mirror}}{{enable_source}}{{is_sid}}Components: main contrib non-free{{has_nfw}}
...
{{security_official}}{{is_sid}}Components: main contrib non-free{{has_nfw}}
...
{{security_official}}{{enable_source}}{{is_sid}}Components: main contrib non-free{{has_nfw}}
```
