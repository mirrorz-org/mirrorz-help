...
**注：该镜像是 Homebrew / Linuxbrew 源程序以及 formula / cask 索引的镜像（即 `brew update` 时所更新内容）。镜像站同时提供相应的二进制预编译包的镜像，请参考 [Homebrew bottles 镜像使用帮助](https://help.mirrorz.org/homebrew-bottles/)**
...
TODO: fix tuna homebrew force redirect
...
并前往[Homebrew bottles 镜像使用帮助](https://help.mirrorz.org/homebrew-bottles/)中「临时替换」一节设置好 `HOMEBREW_BOTTLE_DOMAIN`
