...
该文件夹只提供 CentOS Stream 9，如果需要非 Stream 版的 CentOS，请参考 [centos 的帮助](/centos/)。
...
<CodeBlock
  enableQuickSetup
  filepath="/etc/yum.repos.d/centos.repo"
>
...
<CodeBlock
  enableQuickSetup
  filepath="/etc/yum.repos.d/centos-addons.repo"
>
