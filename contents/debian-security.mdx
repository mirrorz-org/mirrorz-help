...
{{is_sid}}deb {{http_protocol}}{{mirror}} {{release_name}}{{security}} main contrib non-free
{{is_sid}}{{enable_source}}deb-src {{http_protocol}}{{mirror}} {{release_name}}{{security}} main contrib non-free
```
