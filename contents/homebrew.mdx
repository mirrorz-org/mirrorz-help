...
brew tap --custom-remote homebrew/autoupdate {{http_protocol}}{{mirror}}/homebrew-autoupdate.git
brew update

# 或使用下面的几行命令自动设置
export HOMEBREW_CORE_GIT_REMOTE="{{http_protocol}}{{mirror}}/homebrew-core.git"
for tap in core cask autoupdate; do
...
brew tap --custom-remote homebrew/autoupdate https://github.com/Homebrew/homebrew-autoupdate
